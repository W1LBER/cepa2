...
class WinemakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create winemaker" do
    assert_difference('Winemaker.count') do
      post winemakers_url, params: { winemaker: { age: @winemaker.age, country: @winemaker.country, magazine_id: @winemaker.magazine_id, name: @winemaker.name, position_id: @winemaker.position_id } }
    end
  ...
  test "should update winemaker" do
    patch winemaker_url(@winemaker), params: { winemaker: { age: @winemaker.age, country: @winemaker.country, magazine_id: @winemaker.magazine_id, name: @winemaker.name, position_id: @winemaker.position_id } }
